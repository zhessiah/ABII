...
class TrafficJunctionEnv(gym.Env):
    ...
    def __init__(self, dim=10, vision=1, add_rate_min=0.05, add_rate_max=0.2, curr_start=0, curr_end=0, difficulty="easy", vocab_type="bool",
                nagents=5):
    ...
    def _get_reward(self):
        ...
        reward = tuple( np.reshare(reward, (-1,)) )
        return reward
